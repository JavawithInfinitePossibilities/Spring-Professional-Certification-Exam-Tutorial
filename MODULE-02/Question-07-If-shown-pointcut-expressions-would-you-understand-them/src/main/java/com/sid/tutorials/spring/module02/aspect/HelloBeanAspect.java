...
public class HelloBeanAspect {
	...
	/*
	 * @Before("args(..)") public void argsExample1() {
	...
	/*
	 * @Before("args(String, *)") public void argsExample3() {
	 * System.out.println("Before - argsExample3"); }
	 */

	/*
	 * @Before("args(java.lang.String)") public void argsExample4() {
	...
	@Before("@annotation(com.sid.tutorials.spring.module02.annotation.CustomTransaction)")
	...
	/*
	 * @Before(
	 * "@args(com.sid.tutorials.spring.module02.annotation.CustomValidation)")
