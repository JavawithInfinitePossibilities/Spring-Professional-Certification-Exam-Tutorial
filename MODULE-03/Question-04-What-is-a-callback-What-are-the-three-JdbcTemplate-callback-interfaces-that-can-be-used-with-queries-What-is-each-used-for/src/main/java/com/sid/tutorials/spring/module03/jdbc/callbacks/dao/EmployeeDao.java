package com.sid.tutorials.spring.module03.jdbc.callbacks.dao;
...
import com.sid.tutorials.spring.module03.jdbc.callbacks.ds.Employee;
...
public class EmployeeDao {
	...
	public double findAverageSalaryModernImplementation() {
		return jdbcTemplate.queryForList("select salary from employee", Double.class).stream()
				.mapToDouble(Double::valueOf).average().orElse(0f);
	}
