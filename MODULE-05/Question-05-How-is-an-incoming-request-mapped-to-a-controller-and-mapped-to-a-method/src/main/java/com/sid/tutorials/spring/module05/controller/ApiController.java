...
import com.sid.tutorials.spring.module05.ds.ArticleCriteria;
...
public class ApiController {
    ...
    // curl localhost:8080/question05/api/articles |jq
    @GetMapping
    ...
    // curl -I localhost:8080/question05/api/articles
    ...
    // curl localhost:8080/question05/api/articles/2 |jq
    @GetMapping("{id}")
    ...
    // curl -X POST localhost:8080/question05/api/articles/search -H 'Content-Type: application/json' -d '{"bodyLike": "%some%"}' |jq
    ...
    // curl -v -X PUT localhost:8080/question05/api/articles -H 'Content-Type: application/json' -d '{"title": "New article", "body": "New article content"}'
    @PutMapping
    ...
    // curl -v -X PATCH localhost:8080/question05/api/articles/1 -H 'Content-Type: application/json' -d '{"title": "Updated article", "body": "Updated article content"}'
    ...
    // curl -v -X DELETE localhost:8080/question05/api/articles/3
    @DeleteMapping("{id}")
