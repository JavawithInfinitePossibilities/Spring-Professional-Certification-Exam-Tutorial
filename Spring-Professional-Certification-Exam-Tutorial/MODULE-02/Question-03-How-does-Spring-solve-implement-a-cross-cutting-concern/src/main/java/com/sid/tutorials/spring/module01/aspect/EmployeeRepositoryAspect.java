...
public class EmployeeRepositoryAspect {
    @Before("execution(* com.sid.tutorials.spring.module01.service.a.EmployeeRepository.findEmployeeById(..))")
    public void beforeFindEmployeeById() {
        System.out.println("Service A - beforeFindEmployeeById");
    }

    @After("within(com.sid.tutorials.spring.module01.service.a.*)")
