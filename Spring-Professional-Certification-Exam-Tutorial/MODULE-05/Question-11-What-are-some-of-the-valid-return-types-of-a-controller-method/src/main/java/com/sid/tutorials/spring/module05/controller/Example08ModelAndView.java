...
public class Example08ModelAndView {
	...
	public ModelAndView example08A() {
		return new ModelAndView("person-display", "person", new Person("John", "Doe"));
	}

	// Visit http://localhost:8080/example08B
	@GetMapping("/example08B")
	public ModelAndView example08B() {
		return new ModelAndView("names-and-cities", Map.of("names", asList("John", "Mary", "William", "James"),
				"cities", asList("New York City", "Tokyo", "Sydney", "Bengaluru")), HttpStatus.OK);
	}
}
